...
// Kompletna, zaktualizowana struktura danych.
// ===================================================================================
const schedulesData = {
    "myslenice-dobczyce": {
    ...
    "myslenice-dobczyce": {
        ...
        directions: [{
            ...
            times: {
                ...
                sundays: [] tak jak w sobotę + 22: 15
            }
        }, {
        directionName: "z Dobczyc do Myślenic",
        times: {
            ...
            sundays: [] ostatni 21:15 w tygodniu
        }
    }]
    },
"myslenice-biertowice": {
    routeName: "Myślenice <-> Biertowice", z kartą
    validFrom: "01.07.2025",
        acceptsCard: true,
            directions: [{
    ...
    directionName: "z Dobczyc do Gdowa",
        ...
        workdays: [
            ...
            saturdays: [
                ...
                sundays: [] jak w sobotę(bez dodatkowych kursów)
    }
}]
},
"myslenice-krzyszkowice": { z kartą
...
"myslenice-gdow": {
    routeName: "Myślenice <-> Gdów", połączyć z tym z Gdowa do Dobczyc
        validFrom: "01.07.2025",
        directions: [{
            ...
            times: {
                ...
                sundays: [] tak jak w soboty bez dodatkowych dodatkowo
            }
        }, {
            ...
            times: {
                ...
                sundays: [] tak jak w sobote bez dodatkowych, za mało kursów sprawdzić ze starym rozkładem
            }
        }]
},
"myslenice-poreba": { z kartą
